"""
Django settings for testrfresgrtgrtehd__47375 project.
...
ROOT_URLCONF = 'testrfresgrtgrtehd__47375.urls'
...
WSGI_APPLICATION = 'testrfresgrtgrtehd__47375.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testrfresgrtgrtehd__47375 API",
    "DESCRIPTION": "API documentation for testrfresgrtgrtehd__47375 App",
    "VERSION": "v1",
}
